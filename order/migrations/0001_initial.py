# Generated by Django 2.0.7 on 2019-05-03 06:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_status', models.CharField(choices=[('WAIT_BUYER_PAY', '交易创建'), ('TRADE_FINISHED', '交易结束'), ('TRADE_SUCCESS', '成功'), ('TRADE_CLOSE', '交易关闭'), ('paying', '待支付')], default='paying', max_length=20, verbose_name='交易状态')),
